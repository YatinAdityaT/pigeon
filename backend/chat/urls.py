    ...
    path(
        r'api/', include(
            [
                ...
                re_path(
                    r'messages/update/(?P<pk>[\w-]{36})',
                    MessageUpdateView.as_view()
                ),

                # Delete a message
                re_path(
                    r'messages/delete/(?P<pk>[\w-]{36})',
